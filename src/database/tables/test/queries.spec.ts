import { LOG_ACCESS, LOG_CALL, LOG_CONFERENCE, LOG_CONFERENCE_PARTICIPANT } from "../config";
...
export const logCallQuery = async (model: sequelize.Model<string, {}>) => {
  ...
  const query = await model.bulkCreate([{
    ...
    [LOG_CALL.fields.userIdFrom.value]: 'bc3357ba817994aa764471ccff6a375d',
    [LOG_CALL.fields.userIdTo.value]: '95184185ba39e4e832b7dd95c8ff54d1',
    ...
    [LOG_CALL.fields.userIdFrom.value]: '95184185ba39e4e832b7dd95c8ff54d1',
    [LOG_CALL.fields.userIdTo.value]: 'bc3357ba817994aa764471ccff6a375d',
...
export const logConferenceQuery = async (model: sequelize.Model<string, {}>) => {
  ...
  const query = await model.bulkCreate([{
    ...
    [LOG_CONFERENCE.fields.userIdFrom.value]: 'bc3357ba817994aa764471ccff6a375d',
    ...
    [LOG_CONFERENCE.fields.userIdFrom.value]: '95184185ba39e4e832b7dd95c8ff54d1',
...
export const logConferenceParticipantQuery = async (model: sequelize.Model<string, {}>) => {
  const query = await model.bulkCreate([{
    ...
    [LOG_CONFERENCE_PARTICIPANT.fields.userId.value]: '95184185ba39e4e832b7dd95c8ff54d1',
    ...
    [LOG_CONFERENCE_PARTICIPANT.fields.userId.value]: 'bc3357ba817994aa764471ccff6a375d',
